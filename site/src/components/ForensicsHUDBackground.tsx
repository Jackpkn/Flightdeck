...
export default function ForensicsHUDBackground() {
  ...
  return (
    <div className="absolute inset-0 pointer-events-none overflow-hidden select-none flex items-center justify-center pt-16 md:pt-24">
      {/* 1. Deep Violet & Claude Amber Nebula Wash */}
      <div
        className="absolute w-[1250px] h-[750px] rounded-full opacity-45"
        style={{
          background:
            "radial-gradient(ellipse at 50% 40%, #4c1d95 0%, #1e1145 45%, transparent 75%)",
          filter: "blur(95px)",
        }}
      />

      <div
        className="absolute w-[680px] h-[400px] rounded-full opacity-35"
        style={{
          background:
      ...
      {/* 2. Parallax Forensics DAG & Token Flow Geometry */}
      <div
