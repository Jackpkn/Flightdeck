...
const ARCH_CONFIGS: Record<"universal" | "homebrew", ArchitectureConfig> = {
  universal: {
    ...
    filename: "Flightdeck-0.2.0.dmg",
    size: "12.6 MB",
    sha256: "1441039a80ed50ec6a5a7c59c9045e50667422bb60ae137d24d56258b085894c",
    downloadUrl: "https://github.com/Jackpkn/Flightdeck/releases/download/v0.2.0/Flightdeck-0.2.0.dmg",
  },
  homebrew: {
    arch: "homebrew",
    label: "Homebrew Tarball",
    sublabel: "Universal Bottle · Zero Gatekeeper Friction",
    filename: "Flightdeck-0.2.0-universal.tar.gz",
    size: "11.1 MB",
    sha256: "947eeebde05521719704ed34a15c29b00b221de4ca4ece3186984bef93e69aa8",
    downloadUrl: "https://github.com/Jackpkn/Flightdeck/releases/download/v0.2.0/Flightdeck-0.2.0-universal.tar.gz",
  },
};
